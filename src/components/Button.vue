  ...
  return cva(
    " flex items-center justify-center font-medium transition-all font-main whitespace-nowrap",
    {
      variants: {
        variant: {
          default:
            "text-white px-4 py-2 bg-slate-900 rounded-md hover:bg-slate-700",
          destructive:
            "text-white px-4 py-2 bg-red-500 rounded-md hover:bg-red-600",
          outline:
            "border bg-white px-4 py-2 text-slate-900 rounded-md hover:bg-slate-100",
          subtle:
            "bg-slate-100 px-4 py-2 text-slate-900 rounded-md hover:bg-slate-200",
          ...
          iconCircle:
            "rounded-full p-2 text-slate-900 border hover:bg-slate-100",
